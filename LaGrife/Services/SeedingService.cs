...
namespace LaGrife.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Vendedor vendedor2 = new Vendedor(2, "Marcos Junior", "Marc10Jr@outlook.com", new DateTime(1992, 8, 13), loja2);

            Vendas v1 = new Vendas(1, new DateTime(2025, 03, 14), 425.00, VendaStatus.Pendente, vendedor1);
            Vendas v2 = new Vendas(1, new DateTime(2025, 03, 11), 100.00, VendaStatus.Comprado, vendedor2);
            Vendas v3 = new Vendas(1, new DateTime(2025, 03, 14), 225.00, VendaStatus.Comprado, vendedor1);
            Vendas v4 = new Vendas(1, new DateTime(2025, 03, 13), 200.00, VendaStatus.Cancelada, vendedor2);
